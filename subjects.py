...
def data_subjects():
    ...
    data_subj.to_csv('/data_processed/data_subjects_percentages.csv', index=False)

# train_eicu = pd.read_csv('/data_processed_eicu/train_df.csv')
# test_eicu = pd.read_csv('/data_processed_eicu/test_df.csv')
